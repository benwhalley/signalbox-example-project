...
from question import QuestionInInstrument, ChoiceSet, Choice
...
class Instrument(models.Model):
    ...
    questions = models.ManyToManyField(
        'Question', through="QuestionInInstrument")
    ...
    def dump_json(self):
        ...
        question_in_instruments = QuestionInInstrument.objects.filter(
            instrument=self)
    ...
    def clean(self):
        ...
        if self.pk and self.questions.all().count() > 1000:
...
class InstrumentInAskPage(models.Model):
    ...
    order = models.FloatField(default=0, verbose_name="Page order", help_text="""Place within the
    ...
    def all_questions(self):
        qlist = list(QuestionInInstrument.objects.select_related(
